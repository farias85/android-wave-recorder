...
package gps.cenpis.cu.waverecorder.oscilogram.newventures;
...
public class NewVentureActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_new_venture);
    ...
    private short[] getAudioSample() throws IOException{
        InputStream is = getResources().openRawResource(R.raw.aeiou);
        byte[] data;
        try {
    ...
    private void requestMicrophonePermission() {
        if (ActivityCompat.shouldShowRequestPermissionRationale(this, android.Manifest.permission.RECORD_AUDIO)) {
            ...
            Snackbar.make(mRealtimeWaveformView, "Microphone access is required in order to record audio",
                ...
                @Override
                public void onClick(View v) {
                    ActivityCompat.requestPermissions(NewVentureActivity.this, new String[]{
